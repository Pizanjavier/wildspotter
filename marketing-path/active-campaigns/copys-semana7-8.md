...
### Jue 7 — O1 "¿Puedes Aparcar Aquí?" (Natura 2000) — Reel — TikTok + IG

> 📋 Engagement 5-3-1: ver [engagement-list-may7.md](engagement-list-may7.md)

> Copy sin cambios del plan original. Ya tiene Remotion: `QuizLegal`.
...
Pero está dentro de una zona Natura 2000. Multa de hasta 600€.
...
> **Cambio V4 respecto al copy original:** Se añade "¿Alguna vez has aparcado en una zona protegida sin saberlo? 👇" para activar comentarios.

---

### Vie 8 — O3 "¿Puedes Aparcar Aquí?" (Ley de Costas) — Reel — TikTok + IG

> 📋 Engagement 5-3-1: ver [engagement-list-may8.md](engagement-list-may8.md)

> Copy con pequeña modificacion para añadir pregunta de engagement.
...
### Sab 9 — S1 "El Problema" — Reel — IG + TikTok

> 📋 Engagement 5-3-1: ver [engagement-list-may9.md](engagement-list-may9.md)

> Sustituye K1 "Gatekeeping repost". Formato emoción/problema-solucion. Concepto nuevo.
> Produccion: Stock footage parking lleno → spot solitario. Texto animado. Musica ambient.
...
### Dom 10 — W1 "83.006" (sustituye repost) — Reel — IG + TikTok

> 📋 Engagement 5-3-1: ver [engagement-list-may10.md](engagement-list-may10.md)

> Sustituye el repost del mejor carousel. Reel nuevo con counter animation.
...
```
Esto es lo que ve el radar cuando escaneas una zona de 50km.

[Captura borrosa/pixelada del mapa con puntos de colores — sin zoom para ver ubicaciones]

Cada punto es un candidato. Solo unos pocos pasan los 7 filtros.
```
...
**Caption IG + TikTok:**
```
5 señales de que un spot va a ser bueno.
...
```
Score: 84.5/100.
Matorral boscoso de transición. Final de pista.
0 edificios en 300m. Sin ruido de carretera. Pendiente: 0.7%.

Zona rústica no protegida. Cero vecinos a menos de 700m.
Elevación: 464m. Bonus salvaje: +21.

Mayo es el mejor momento. Dentro de 6 semanas esto estará lleno.

¿En qué comunidad crees que está? 👇
...
> **Nota:** Si los datos de score reales del pipeline difieren, actualizar el score y los sub-scores antes de publicar. Nunca inventar datos — usar siempre el pipeline real.
...
```
Score: 86.8/100.
Bosque de frondosas. Agua cerca. Final de pista.
0 edificios en 300m. Sin ruido de carretera. Pendiente: 3.5%.

Uso del suelo rústico. Totalmente fuera de Natura 2000.
Elevación: 805m. 0 vecinos en 3km. Bonus salvaje: +22.

Interior de España. Lejos de todo.

¿Dehesa o costa? ¿Qué prefieres para pernoctar? 👇
...
Vista al mar desde 120m de altura.
0 edificios en 300m. 0 vecinos en 2km.
...
Solo en WildSpotter. Gratis en iOS -> link en bio

#vanlife #vidaenfurgo #spotsecreto #espana #furgocamper
```
...
#vanlife #vidaenfurgo #furgocamper #debate #espana
```
...
### Dom 24 — RD7 o Reel libre — IG + TikTok

> Opción A: RD7 si hay un nuevo spot procesado con datos interesantes.
> Opción B: Reel de cierre de semana con retrospectiva ligera.

**Opción A — RD7 (rellenar con datos reales del pipeline):**
```
Score: [X]/100.
[Tipo de paisaje]. [Detalle del entorno].
[Sub-scores del pipeline].
...
Prioridad media:
5. `RD6` — Interior/dehesa (Lun 18) — Datos reales del pipeline.
6. `S3` — "Un 91" (Jue 21) — Score reveal emotivo.
7. `U1` — Carousel "Reviews paradox" (Mie 20) — 5 slides Remotion Still.

### Render de carousels

```bash
# T1 — 5 señales (5 slides)
for i in $(seq 1 5); do npx remotion still Carousel-Scoring-$i --image-format=png out/carousel-t1-$i.png; done

# U1 — Reviews paradox (5 slides + cover)
for i in $(seq 1 6); do npx remotion still Carousel-Mystery-$i --image-format=png out/carousel-u1-$i.png; done
```

> Nota: Los IDs de carousel corresponden a los ya registrados en Root.tsx. Si los nuevos conceptos T1/U1 necesitan slides distintas, el remotion-producer debe registrar nuevos IDs.
