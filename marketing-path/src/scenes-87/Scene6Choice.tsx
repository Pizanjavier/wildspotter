...
export const Scene6Choice: React.FC = () => {
	...
	const topZoom = interpolate(frame, [0, 180], [1.0, 1.1], {
		extrapolateRight: "clamp",
	});
	const bottomZoom = interpolate(frame, [0, 180], [1.0, 1.08], {
		extrapolateRight: "clamp",
	});
		...
		<AbsoluteFill style={{ background: "#0F0D0B", overflow: "hidden" }}>
			...
			>
				...
				<div
					style={{
						...
						height: 200,
						background:
							"linear-gradient(180deg, rgba(15,13,11,0.7) 0%, transparent 100%)",
					}}
				/>
				...
				<div
					style={{
						...
						height: 180,
						background:
							"linear-gradient(0deg, rgba(15,13,11,0.6) 0%, transparent 100%)",
					}}
				/>
			</div>
			...
			>
				...
				<div
					style={{
						...
						height: 180,
						background:
							"linear-gradient(180deg, rgba(15,13,11,0.6) 0%, transparent 100%)",
					}}
				/>
				...
				<div
					style={{
						...
						height: 350,
						background:
							"linear-gradient(0deg, rgba(15,13,11,0.95) 0%, rgba(15,13,11,0.5) 60%, transparent 100%)",
					}}
				/>
			</div>
			...
			<div
				style={{
					...
					height: 3,
					background:
						"linear-gradient(90deg, transparent 5%, rgba(217,119,6,0.5) 20%, rgba(217,119,6,0.7) 50%, rgba(217,119,6,0.5) 80%, transparent 95%)",
			...
			>
				<div
					style={{
						...
						letterSpacing: -5,
						textShadow:
							"0 4px 50px rgba(0,0,0,0.95), 0 0 100px rgba(0,0,0,0.6)",
					}}
				>
					Elige.
				</div>
