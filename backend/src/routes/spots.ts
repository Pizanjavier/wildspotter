...
const spotDetailSchema = {
  ...
  properties: {
    ...
    spot_type: { type: ['string', 'null'] },
    surface_type: { type: ['string', 'null'] },
    osm_tags: { type: ['object', 'null'], additionalProperties: true },
    elevation: { type: ['number', 'null'] },
    slope_pct: { type: ['number', 'null'] },
    ...
    landcover_class: { type: ['string', 'null'] },
    landcover_label: { type: ['string', 'null'] },
    siose_dominant: { type: ['object', 'null'], additionalProperties: true },
    composite_score: { type: ['number', 'null'] },
