...
const Dots = ({ currentPage, colors }: { currentPage: number; colors: ThemeColors }) => (
    ...
    {Array.from({ length: TOTAL_PAGES }).map((_, i) => (
      <View
        ...
        style={[
          ...
          {
            backgroundColor:
              i === currentPage ? colors.ACCENT : colors.BORDER,
          },
        ]}
      />
    ))}
  ...
  <View style={styles.page}>
    <View style={styles.pageTop}>
      <View style={[styles.iconRing, { borderColor: colors.ACCENT + '20' }]}>
        <View style={[styles.iconRingInner, { backgroundColor: colors.ACCENT + '15' }]}>
...
const HowItWorksPage = ({
  ...
  <View style={styles.page}>
    <View style={[styles.pageTop, { justifyContent: 'center', paddingHorizontal: 24 }]}>
      {STEPS.map((step, i) => (
        <StepRow
          key={i}
          num={i + 1}
